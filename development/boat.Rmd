...
`r 2280/F`, which is not very close to unity. However, reasonable corrections might be:

* Assuming 45 percent efficiency of a diesel engine, the ratio becomes `r 2280/F/0.45`
* Assuming 40 percent propellor efficiency (ref 2 guess) gives ratio `r 2280/F/0.45/0.4`
* Assuming skin friction to be 70 percent of total friction gives ratio `r 2280/F/0.45/0.4/0.7`
