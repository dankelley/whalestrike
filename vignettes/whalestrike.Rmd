...
length, and the thicknesses of the four sublayers in the model. Try adjusting them,
...
perhaps exploring the effect of ship mass.  Having built intuition from this, try
...
opar <- par(mfcol = c(1, 3), mar = c(3.3, 3, 1, 2), mgp = c(2, 0.7, 0), cex = 0.7)
plot(sol)
par(opar)
```
