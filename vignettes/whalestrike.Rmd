...
the speed until the blubber threat level decrease to below 1.0, (2) vary whale
length to consider the effects of strikes on immature animals, and (3) model
strikes near the mandible, by altering the thickness, modulus, and strength of
the sublayer. (See the documentation for [parameters](../help/parameters) to
learn how to set the relevant parameters of the ship and whale, and use that
for [strike](../help/strike) to learn about setting vessel speed and the
