...
- Update
  ...
  use collapsible GUI elements and to have pull-down menus for ship type
  and whale species, the selection of which alters the sliders that set
  for ship and whale properties.

## whalestrike 0.5.1

- Fix typo in help for
  [`whaleMassFromLength()`](https://dankelley.github.io/whalestrike/reference/whaleMassFromLength.md),
  in which the exponents on `L` showed only the first digit.
...
- Update `app2()` to have popup information, as suggested by a Hansen
  ...
  and the JOSS paper were also altered as suggested in Johnson’s review.

## whalestrike 0.4.3

- Update code to address documentation problems reported in issues
  [\#25](https://github.com/dankelley/whalestrike/issues/25),
  [\#26](https://github.com/dankelley/whalestrike/issues/26) and
  [\#27](https://github.com/dankelley/whalestrike/issues/27), as well as
  comments on the vignette. For all of these, I thank JOSS reviewer
  Alexandra Mayette.
- Update year of Kelley et al. “assessing” paper to 2021 throughout all
  documentation (issue
  [\#28](https://github.com/dankelley/whalestrike/issues/28)).

## whalestrike 0.4.2

- Create a [video recording](https://youtu.be/kTMl3nXa5A4) demonstrating
  `app2()`.
- Add `app2()`, an improved version of
