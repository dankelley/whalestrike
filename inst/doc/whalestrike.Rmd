...
The right panel shows an ad-hoc estimate of the threat to injury of whale skin,
blubber, and sub-layer.  This is calculated as the ratio of stress to relevant
material strength.  The axis on the right of the sub-layer panel has labels to
indicate potentially low, medium, high, and extreme threat levels, where this
ratio is 0, 1/2, 1, and 3/2, respectively.  Increasingly dark colour is also
used to indicate these boundaries. Given the parameters used for this
simulation, the sub-layer is in high threat of damage.

Readers may find it instructive to rerun the simulation with different
parameters, e.g. (1) lower the speed until the threat levels decrease
to, say, the 'M' mark, (2) vary blubber thickness to address strikes at
different spots on the whale body, or strikes on whales of varying health, and
(3) model strikes near the mandible, by altering the thickness, modulus, and
strength of the sub-layer.
...
## Blubber-damage dependence on impact area
...
**Suggested work:** explore the effect of varying sublayer properties and
